...
{
  new (message_memory) amr_v4_msgs_srvs::msg::Robot(_init);
}

void Robot_fini_function(void * message_memory)
{
  auto typed_message = static_cast<amr_v4_msgs_srvs::msg::Robot *>(message_memory);
  typed_message->~Robot();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Robot_message_member_array[3] = {
  {
    ...
    offsetof(amr_v4_msgs_srvs::msg::Robot, robot_localization_status),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(amr_v4_msgs_srvs::msg::Robot, localized),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(amr_v4_msgs_srvs::msg::Robot, robot_active_status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Robot_message_members = {
  ...
  "Robot",  // message name
  3,  // number of fields
  sizeof(amr_v4_msgs_srvs::msg::Robot),
...
{
  return &::amr_v4_msgs_srvs::msg::rosidl_typesupport_introspection_cpp::Robot_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, amr_v4_msgs_srvs, msg, Robot)() {
  return &::amr_v4_msgs_srvs::msg::rosidl_typesupport_introspection_cpp::Robot_message_type_support_handle;
}
